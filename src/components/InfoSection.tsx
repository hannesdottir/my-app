...
const InfoSection: FC = ({}) => {
  ...
  return (
    <div className='my-11 text-primaryTextColor'>
        <h1 className='flex md:justify-center items-center font-extrabold mx-4 md:text-xl lg:text-2xl lg:py-6'>{t('infosection.title')}</h1>
        <div className='md:flex md:flex-row-reverse md:justify-center md:items-center'>
          ...
          <div className='md:flex md:items-center md:flex-col'>
              <div className='md:w-4/6 mx-4 md:mt-12'>
                <h2 className='text-blueTextColor font-bold text-xl md:text-2xl lg:text-3xl mb-3'>{t('infosection.primary_1')}</h2>
              ...
              <div className='md:w-4/6 mx-4 my-10'>
                  <h2 className='text-blueTextColor font-bold text-xl lg:text-3xl my-3'>{t('infosection.primary_2')}</h2>
