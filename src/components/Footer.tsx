  ...
  return (
    <div className='bg-darkBackground text-white flex flex-col'>
        <div className='my-11 mx-5 md:mx-40'>
            ...
            <div className="lg:grid lg:grid-cols-3 lg:gap-4 lg:my-14 lg:items-center">
                ...
                <div className='justify-self-center mt-7 md:mt-0'>
                ...
                <div className='flex flex-col justify-self-end mt-7 md:mt-0'>
